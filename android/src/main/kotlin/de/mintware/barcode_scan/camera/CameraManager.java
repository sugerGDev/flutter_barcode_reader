...
package de.mintware.barcode_scan.camera;
...
public final class CameraManager {
    ...
    static final int SDK_INT; // Later we can use Build.VERSION_ORDER.SDK_INT
    ...
    private CameraManager(Context context) {
        ...
        //useOneShotPreviewCallback = Integer.parseInt(Build.VERSION_ORDER.SDK) > Build.VERSION_CODES.CUPCAKE;
